...
class Boleta:
  ...
  def mostrarBoleta(self):
    ...
    for renglon in self.renglones :
      datos_prod=self.cur.execute("select desc_prod,valor from productos,precios where productos.id_prod={1} and id_precio={2}".format(renglon[0],renglon[2])).fetchone()
